...
def get_text_locations(image, east_path="frozen_east_text_detection.pb", width=320, height=320, padding=0.05):
...
# print (get_text_locations(cv2.imread("../../example_01.jpg")))